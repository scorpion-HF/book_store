...
ALLOWED_HOSTS = ['oghyanoosedanesh.ir', 'www.oghyanoosedanesh.ir']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'oghyanoo_book_store',
        'USER': 'oghyanoo_book_store_admin',
...
STATIC_URL = '/static/'
STATIC_ROOT = '/home1/oghyanoo/public_html/static'
MEDIA_ROOT = '/home1/oghyanoo/public_html/media'

# MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
MEDIA_URL = '/media/'

EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'mail.oghyanoosedanesh.ir'
