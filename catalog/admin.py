...
from .models import Book, PrintedBook, ElectronicBook, Author, Category
...
class PrintedBookModelAdmin(ModelAdminJalaliMixin, admin.ModelAdmin):
    list_display = ['title', 'price', 'date_of_publish_jalali']
...
class ElectronicBookModelAdmin(ModelAdminJalaliMixin, admin.ModelAdmin):
    list_display = ['title', 'price', 'date_of_publish_jalali']
    filter_horizontal = ('authors', 'categories',)
